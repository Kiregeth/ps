                ...
                <form id='ajax-form' method='post' action='/quick_edit'>
                    ...
                    <div class="">
                        <table class="table table-striped table-bordered editableTable" id="myTable" >
                            <thead>
                            <tr>
                                <?php if(in_array('create',session('permission'))): ?>
                            ...
                            <tbody>
                            <?php  if(in_array('create',session('permission'))) $read=""; else $read="readonly";  ?>
                            <tr>
    ...
    <script type="text/javascript">
        ...
        $(function (){
            $(".delete").click(function(){
                ...
                var col='Ref_No';
                $.post('/delete', {'db_table':'<?php echo e($db_table); ?>','w_id': id,'w_col': col,'_token':$('input[name=_token]').val()}, function(response) {(response)?alert(response):location.reload(true);});
            });
        });
        <?php endif; ?>
        <?php if(in_array('transfer',session('permission'))): ?>
