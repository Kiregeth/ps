    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 col-xs-12">
                <div class="row">
                    <div class="col-xs-4 col-md-4"><h1>Old Visa Process</h1></div>
    ...
    <script type="text/javascript">
        ...
        $(function (){
            $(".deploy").click(function(){
                ...
                var col='Ref_No';
                $.post('/deploy', {'db_table1':'visaprocesses','db_table2':'vrflowns','db_table3':'databanks','w_id': id,'w_col': col,'_token':$('input[name=_token]').val()}, function(response) {(response)?alert(response):location.reload(true);});
            });
        });
        ...
        function autosubmit(colArray,myCol,myRow)
        {
            ...
            $.post(action, {'db_table':'visaprocesses','val':value,'col':column,'w_col': where_col,'w_val': where_val,'_token':$('input[name=_token]').val()}, function(response) {(response)?alert(response):null});
